    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-20">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-sm text-muted-foreground">Open Source - Licenca MIT</span>
        </motion.div>
        ...
        >
          O Sistema de Contexto Persistente
        </motion.p>
        ...
        >
          para <span className="text-primary">Acessibilidade</span>
        </motion.p>
        ...
        >
          Um sistema de contexto para construir software acessivel por padrao — 
          para desenvolvedores e IA, com regras aplicaveis alinhadas ao WCAG 2.2.
        </motion.p>
        ...
        >
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-lg bg-card border border-border font-mono text-sm">
            ...
            <code className="text-foreground">git clone https://github.com/fecarrico/A11Y.md.git</code>
          </div>
        </motion.div>
      </div>
